package net.potatocult.mobsofmobs.entities.passive;
...
public class GoldGolemEntity extends GolemEntity {
    protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.createKey(GoldGolemEntity.class, DataSerializers.BYTE);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        GoldGolemEntity.Cracks goldgolementity$cracks = this.func_226512_l_();
        boolean flag = super.attackEntityFrom(source, amount);
        if (flag && this.func_226512_l_() != goldgolementity$cracks) {
    ...
    public Cracks func_226512_l_() {
        return GoldGolemEntity.Cracks.func_226515_a_(this.getHealth() / this.getMaxHealth());
    }
