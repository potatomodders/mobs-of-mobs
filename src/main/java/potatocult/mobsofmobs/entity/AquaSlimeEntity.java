...
public class AquaSlimeEntity extends MobsofMobsElements.ModElement {
	...
	public AquaSlimeEntity(MobsofMobsElements instance) {
		super(instance, 44);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f)).build("aquaslime")
						.setRegistryName("aquaslime");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -16750900, -16737844, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("aquaslime"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new SlimeModel(0), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("mobs_of_mobs:textures/pack.png");
				}
			};
		});
	}
