...
public class PenguinFeatherItem extends MobsofMobsElements.ModElement {
	@ObjectHolder("mobs_of_mobs:penguinfeather")
	public static final Item block = null;
	public PenguinFeatherItem(MobsofMobsElements instance) {
		super(instance, 18);
	}
